...
| 항목 | 칼럼 | 갯수 | 데이터타입 | 비고 |
|---|---|---|---|---|
| 관광지(음식점,숙박) 기본 데이터 | 이름, 별점, 태그, 주소, 전화번호, 좋아요, 찜하기, 리뷰, 방문자, 조회, SNS공유, 상세설명, 이용안내, 이미지URL | 1488 | object | - |

### 관광지 설명 데이터
| 항목 | 칼럼 | 갯수 | 데이터타입 | 비고 |
|---|---|---|---|---|
| 관광지 설명 데이터 | ID, 이름, 주소, 위도, 경도, 전화번호, 이미지URL | 1480 | int | 웹페이지 구분자 |

### 챗봇 데이터
| 항목 | 칼럼 | 갯수 | 데이터타입 | 비고 |
|---|---|---|---|---|
| 챗봇 데이터 | 이름, 주소, 조회, 상세설명, 이용안내, 임베딩, 태그임베딩 | 1487 | object, float | - |

### 이미지 추천 데이터
| 항목 | 칼럼 | 갯수 | 데이터타입 | 비고 |
|---|---|---|---|---|
| 이미지 추천 데이터 | 이름, 이미지URL, 이미지임베딩, 관광지간 유사도 | 1472 | object | - |

### 관광지별 추천 데이터
| 항목 | 칼럼 | 갯수 | 데이터타입 | 비고 |
|---|---|---|---|---|
| 관광지별 추천 데이터 | ID, 이름, 태그, 조회, 임베딩, 태그임베딩, 유사관광지1, 유사관광지2, 유사관광지3, 유사관광지1의 유사도, 유사관광지2의 유사도, 유사관광지3의 유사도 | 1465 | object, float | - |
